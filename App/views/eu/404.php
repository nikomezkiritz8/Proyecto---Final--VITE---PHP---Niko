...
<html lang="<?= e($lang ?? env('LANG_DEFAULT', 'es')) ?>">
  <head>
    ...
    <title>Orrialdea ez da aurkitu</title>
    <meta name="description" content="Bilatzen ari zaren orrialdea ez dago edo helbidez aldatu da. Itzuli Niko Studioren hasierara edo joan aurreko orrialdera.">
  ...
  <body>
    ...
    <main class="error404" id="eduki-nagusia">
      <section class="error404__panel" aria-labelledby="error404-title">
        <div class="error404__content">
          <p class="error404__eyebrow">404 errorea</p>
          <h1 class="error404__title" id="error404-title">Orrialde hau kodean galdu da</h1>
